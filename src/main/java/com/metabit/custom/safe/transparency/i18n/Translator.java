package com.metabit.custom.safe.transparency.i18n;
    ...
    public static void init(Locale locale) {
        ...
        if (Translator.rb == null) {
        	try {
        		...
        		// If bundle not found, create an empty bundle to prevent crashes
        		LOGGER.warn("Resource bundle 'i18n/lang' not found for locale " + locale + ", using fallback");
        		Translator.rb = new ResourceBundle() {
        			@Override
        			protected Object handleGetObject(String key) {
        				return null; // Return null so get() returns defaultValue
        			}
        			@Override
